...
@section('title', 'OguzSoft | Hakkımızda')
@section('orta')
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="about-desc">
                    <div class="about-img-1 animate-box" style="background-image: url({{  asset('asset/images/about-img-2.jpg') }});"></div>
                    <div class="about-img-2 animate-box" style="background-image: url({{  asset('asset/images/about-img-1.jpg') }});"></div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="row">
